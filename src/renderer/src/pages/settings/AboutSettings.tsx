    ...
    <SettingContainer theme={theme}>
      <SettingGroup theme={theme}>
        <SettingTitle>
          ...
          <HStack alignItems="center">
            <Link to="https://github.com/OneChat-Dev/OneClaw">
        ...
        <AboutHeader>
          <Row align="middle">
            <AvatarWrapper onClick={() => onOpenWebsite('https://github.com/OneChat-Dev/OneClaw')}>
            ...
            <VersionWrapper>
              ...
              <Tag
                onClick={() => onOpenWebsite('https://github.com/OneChat-Dev/OneClaw/releases')}
                color="cyan"
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingRow>
          ...
          <Button onClick={() => onOpenWebsite('https://github.com/OneChat-Dev/OneClaw/issues/new/choose')}>
