/**
 * AI SDK 到 OneClaw Chunk 适配器
 * 用于将 AI SDK 的 fullStream 转换为 OneClaw 的 chunk 格式
 */
...
/**
 * AI SDK 到 OneClaw Chunk 适配器类
 * 处理 fullStream 到 OneClaw chunk 的转换
 */
export class AiSdkToChunkAdapter {
  ...
  /**
   * 读取 fullStream 并转换为 OneClaw chunks
  ...
  /**
   * 转换 AI SDK chunk 为 OneClaw chunk 并调用回调
