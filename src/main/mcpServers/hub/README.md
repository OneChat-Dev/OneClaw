...
A built-in MCP server that aggregates all active MCP servers in OneClaw and exposes them through **meta-tools**.

This server is the core component of OneClaw’s **Auto MCP Mode**.
