...
CodeBlockView is the core component in OneClaw for displaying and manipulating code blocks. It supports multiple view modes and visual previews for special languages, providing rich interactive tools.
