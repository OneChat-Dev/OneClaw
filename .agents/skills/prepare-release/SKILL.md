...
Automate the OneClaw release workflow: collect changes → generate bilingual release notes → update files → create release branch + PR → trigger CI/CD.
...
```
<!--LANG:en-->
OneClaw {version} - {Brief English Title}
